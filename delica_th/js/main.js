jQuery(function ($) {
  ...
  function scrollTop() {
    ...
    // if (scroll_scr > 101) {
      ...
      // document.querySelector('.header').setAttribute('style','top:-' + document.querySelector('.header_top_row').scrollHeight + 'px;');
      // document.querySelector('.section_bunner').setAttribute('style','padding-top:' + 0 + 'px;')
    } else {
      document.querySelector('.header').classList.remove('scroll');
      // document.querySelector('.header').setAttribute('style','top:' + 0 + 'px;');
